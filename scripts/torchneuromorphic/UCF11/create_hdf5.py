...
def UCF11_load_events_from_bin(file_path, max_duration=None):
...
def create_events_hdf5(directory, hdf5_filename):
    fns_train, fns_test = UCF11_get_file_names(directory)
    ...
    with h5py.File(hdf5_filename, 'w') as f:
        ...
        for file_d in tqdm(fns_train+fns_test):
            ...
            data = UCF11_load_events_from_txt(file_d)
            times = data[:,0]
            addrs = data[:,1:]
