...
class dvsmnistDataset(NeuromorphicDataset):
    directory = 'data/dvsmnist/'
    ...
    def __init__(
        ...
        super(dvsmnistDataset, self).__init__(
                root,
                transform=transform,
...
def create_datasets(
        root = 'data/dvsmnist/dvsmnist.hdf5',
        batch_size = 72 ,
    ...
    train_ds = dvsmnistDataset(root,train=True,
                                 transform = transform_train, 
                                 target_transform = target_transform_train, 
                                 chunk_size = chunk_size_train,
                                 dt = dt)

    test_ds = dvsmnistDataset(root, transform = transform_test, 
