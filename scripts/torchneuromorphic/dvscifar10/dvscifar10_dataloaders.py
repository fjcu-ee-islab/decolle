...
class dvscifar10Dataset(NeuromorphicDataset):
    directory = 'data/dvscifar10/'
    ...
    def __init__(
        ...
        super(dvscifar10Dataset, self).__init__(
                root,
                transform=transform,
    ...
    def download(self):
        isexisting = super(dvscifar10Dataset, self).download()
...
def create_datasets(
        root = 'data/dvscifar10/dvscifar10.hdf5',
        batch_size = 72 ,
    ...
    train_ds = dvscifar10Dataset(root,train=True,
                                 transform = transform_train, 
                                 target_transform = target_transform_train, 
                                 chunk_size = chunk_size_train,
                                 dt = dt)

    test_ds = dvscifar10Dataset(root, transform = transform_test, 
